...
;;;    (eval (read (strcat "(defun c:color_swatch_COLOR_SWATCH_COLOR"
;;;                        (itoa index)
;;;                        "_OnClicked () (ColorButtonOnClick "
;;;                        (itoa index)
;;;                        "))"
;;;                )
;;;          )
...
(defun ColorButtonOnClick (index)
  (dcl-Form-Close color_swatch/COLOR_SWATCH)
    (setvar "cmdecho" 0)
     ; (command ".color" index)
)
